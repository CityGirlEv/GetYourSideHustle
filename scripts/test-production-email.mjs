/**
 * Send one test email through production queue (mypartb.com).
 * Usage: node scripts/test-production-email.mjs [recipient]
 */
import fs from "fs";
...
console.log(`POST ${origin}/api/public/send-test-email → ${recipient}`);
