  ...
  public: {
    Tables: {
      ...
      expert_contact_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "expert_contact_requests_lead_certificate_id_fkey";
            columns: ["lead_certificate_id"];
            isOneToOne: false;
            referencedRelation: "lead_certificates";
      ...
      lead_certificates: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_certificates_expert_contact_request_id_fkey";
            columns: ["expert_contact_request_id"];
            isOneToOne: false;
            referencedRelation: "expert_contact_requests";
            referencedColumns: ["id"];
          },
        ];
      };
    ...
    Enums: {
      app_role: "client" | "advisor" | "admin" | "leads_admin" | "viewer" | "editor" | "qa" | "agent" | "customer";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
