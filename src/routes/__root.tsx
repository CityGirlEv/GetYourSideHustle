...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Muntie's AI Agents · De-identified Medicare Scenario Optimizer" },
      ...
      { property: "og:title", content: "Muntie's AI Agents · De-identified Medicare Scenario Optimizer" },
      ...
      { name: "twitter:title", content: "Muntie's AI Agents · De-identified Medicare Scenario Optimizer" },
