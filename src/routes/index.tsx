      ...
      <div className="space-y-3 lg:space-y-4">
        ...
        <div className="grid lg:grid-cols-2 items-stretch gap-6 lg:gap-8">
          <div className="flex flex-col h-full min-h-0">
            <figure className="flex flex-col h-full flex-1 rounded-2xl border border-border shadow-md overflow-hidden">
              <div className="relative flex-1 min-h-[10rem]">
                <img
                  src={homeCoverHero}
                  alt="Couple reviewing Medicare plan options with Get Part B Optimizer"
              ...
              <figcaption className="shrink-0 bg-primary px-3.5 py-2 sm:px-4 sm:py-2.5 text-primary-foreground">
                ...
                <p className="text-xs sm:text-sm leading-snug font-semibold uppercase text-center mt-0.5 text-yellow-300">
                  You are not alone!
                </p>
        ...
        <div className="flex flex-col h-full min-h-0 gap-3">
          <div className="glass rounded-2xl px-4 py-3 sm:px-5 text-center space-y-0 flex-1 flex flex-col justify-center">
            <div className="w-full text-[10px] sm:text-[11px] font-extrabold uppercase text-center leading-snug tracking-wide px-2.5 py-1 rounded-md border border-sky-400/40 bg-primary text-yellow-300 shadow-sm">
            ...
            <Button
              ...
              className="grad-indigo h-11 px-8 text-base font-bold animate-pulse !text-yellow-300 hover:!text-yellow-200 mx-auto w-fit min-w-[14rem] mt-2"
            >
              BUILD MY SCENARIO →
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            ...
            <div className="glass rounded-xl px-3 py-2 text-xs">
              ...
              <div className="text-muted-foreground mt-0.5">You choose who sees it</div>
            </div>
            <div className="glass rounded-xl px-3 py-2 text-xs">
              <div className="flex items-center gap-2">
              ...
              <div className="text-muted-foreground mt-0.5 whitespace-nowrap">Compare before enroll</div>
            </div>
          </div>
