...
export const COMMON_MEDS_BY_CONDITION: Record<string, { name: string; strength?: string; form?: string; freq?: string; retail?: number }[]> = {
  "Diabetes": [
    ...
    { name: "Novolog (insulin)", strength: "100 U/mL", form: "Vial", freq: "With meals", retail: 289 },
  ],
  "Hypertension": [
  ...
  "COPD": [
    ...
    { name: "Symbicort", strength: "160/4.5 mcg", form: "Inhaler", freq: "Twice daily", retail: 370 },
