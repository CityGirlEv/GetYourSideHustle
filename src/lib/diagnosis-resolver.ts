...
export const MED_CATALOG: MedCatalogEntry[] = [
  ...
  { name: "Metformin", aliases: ["Glucophage"], strength: "500 mg", form: "Tablet", freq: "Twice daily", retail: 10, category: "Diabetes" },
  { name: "Jardiance", aliases: ["empagliflozin"], strength: "10 mg", form: "Tablet", freq: "Daily", retail: 570, category: "Diabetes" },
  { name: "Ozempic", aliases: ["semaglutide"], strength: "1 mg", form: "Injection", freq: "Weekly", retail: 950, category: "Diabetes" },
  { name: "Trulicity", aliases: ["dulaglutide"], strength: "1.5 mg", form: "Injection", freq: "Weekly", retail: 900, category: "Diabetes" },
  { name: "Mounjaro", aliases: ["tirzepatide"], strength: "5 mg", form: "Injection", freq: "Weekly", retail: 1100, category: "Diabetes" },
  { name: "Novolog (insulin)", aliases: ["insulin aspart"], strength: "100 U/mL", form: "Vial", freq: "With meals", retail: 350, category: "Diabetes" },
  { name: "Humalog (insulin)", aliases: ["insulin lispro"], strength: "100 U/mL", form: "Vial", freq: "With meals", retail: 350, category: "Diabetes" },
  { name: "Lantus (insulin)", aliases: ["insulin glargine"], strength: "100 U/mL", form: "Vial", freq: "Daily", retail: 300, category: "Diabetes" },
  // Diabetes DME
  { name: "Dexcom G7", aliases: ["dexcom", "cgm"], strength: "—", form: "CGM (DME)", freq: "Continuous", retail: 350, category: "Diabetes DME" },
  { name: "Freestyle Libre 3", aliases: ["libre", "cgm"], strength: "—", form: "CGM (DME)", freq: "Continuous", retail: 150, category: "Diabetes DME" },
  ...
  // BP
  { name: "Lisinopril", strength: "10 mg", form: "Tablet", freq: "Daily", retail: 8, category: "Hypertension" },
  { name: "Amlodipine", strength: "5 mg", form: "Tablet", freq: "Daily", retail: 8, category: "Hypertension" },
  { name: "Losartan", strength: "50 mg", form: "Tablet", freq: "Daily", retail: 10, category: "Hypertension" },
  { name: "Metoprolol", strength: "25 mg", form: "Tablet", freq: "Twice daily", retail: 10, category: "Hypertension" },
  { name: "Hydrochlorothiazide", aliases: ["HCTZ"], strength: "25 mg", form: "Tablet", freq: "Daily", retail: 8, category: "Hypertension" },
  // Cholesterol
  { name: "Atorvastatin", aliases: ["Lipitor"], strength: "20 mg", form: "Tablet", freq: "Daily", retail: 12, category: "Cholesterol" },
  { name: "Rosuvastatin", aliases: ["Crestor"], strength: "10 mg", form: "Tablet", freq: "Daily", retail: 15, category: "Cholesterol" },
  { name: "Simvastatin", aliases: ["Zocor"], strength: "20 mg", form: "Tablet", freq: "Daily", retail: 10, category: "Cholesterol" },
  // Cardiac / anticoag
  { name: "Eliquis", aliases: ["apixaban"], strength: "5 mg", form: "Tablet", freq: "Twice daily", retail: 550, category: "Anticoagulant" },
  { name: "Xarelto", aliases: ["rivaroxaban"], strength: "20 mg", form: "Tablet", freq: "Daily", retail: 540, category: "Anticoagulant" },
  { name: "Warfarin", aliases: ["Coumadin"], strength: "5 mg", form: "Tablet", freq: "Daily", retail: 15, category: "Anticoagulant" },
  { name: "Aspirin", strength: "81 mg", form: "Tablet", freq: "Daily", retail: 5, category: "Cardiac" },
  // COPD / Asthma
  { name: "Albuterol", aliases: ["ProAir", "Ventolin"], strength: "90 mcg", form: "Inhaler", freq: "As needed", retail: 65, category: "COPD/Asthma" },
  { name: "Spiriva", aliases: ["tiotropium"], strength: "18 mcg", form: "Inhaler", freq: "Daily", retail: 500, category: "COPD/Asthma" },
  { name: "Symbicort", strength: "160/4.5 mcg", form: "Inhaler", freq: "Twice daily", retail: 400, category: "COPD/Asthma" },
  { name: "Advair", strength: "250/50 mcg", form: "Inhaler", freq: "Twice daily", retail: 420, category: "COPD/Asthma" },
  { name: "Trelegy Ellipta", strength: "100/62.5/25 mcg", form: "Inhaler", freq: "Daily", retail: 620, category: "COPD/Asthma" },
  // Sleep DME
  { name: "CPAP machine", aliases: ["cpap", "bipap"], strength: "—", form: "CPAP (DME)", freq: "Nightly", retail: 80, category: "Sleep DME" },
  // Thyroid
  { name: "Levothyroxine", aliases: ["Synthroid"], strength: "50 mcg", form: "Tablet", freq: "Daily", retail: 12, category: "Thyroid" },
  // Kidney
  { name: "Furosemide", aliases: ["Lasix"], strength: "40 mg", form: "Tablet", freq: "Daily", retail: 10, category: "Kidney" },
  { name: "Sevelamer", strength: "800 mg", form: "Tablet", freq: "With meals", retail: 250, category: "Kidney" },
  // Cancer (hormone therapy)
  { name: "Tamoxifen", strength: "20 mg", form: "Tablet", freq: "Daily", retail: 30, category: "Oncology" },
  { name: "Anastrozole", aliases: ["Arimidex"], strength: "1 mg", form: "Tablet", freq: "Daily", retail: 25, category: "Oncology" },
  // Pain / arthritis
  { name: "Meloxicam", strength: "15 mg", form: "Tablet", freq: "Daily", retail: 12, category: "Arthritis" },
  { name: "Celebrex", aliases: ["celecoxib"], strength: "200 mg", form: "Capsule", freq: "Daily", retail: 90, category: "Arthritis" },
  ...
  // GI
  { name: "Omeprazole", aliases: ["Prilosec"], strength: "20 mg", form: "Capsule", freq: "Daily", retail: 12, category: "GI" },
  { name: "Pantoprazole", aliases: ["Protonix"], strength: "40 mg", form: "Tablet", freq: "Daily", retail: 14, category: "GI" },
  // Mental health
  { name: "Sertraline", aliases: ["Zoloft"], strength: "50 mg", form: "Tablet", freq: "Daily", retail: 15, category: "Mental Health" },
  { name: "Escitalopram", aliases: ["Lexapro"], strength: "10 mg", form: "Tablet", freq: "Daily", retail: 15, category: "Mental Health" },
];
