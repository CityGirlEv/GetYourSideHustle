...
export const TEST_CASES: TestCase[] = [
  ...
  // ===== QA Scenarios — QA creates the scenario in the wizard, then audits the system output =====
  {
    ...
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1945 (age 81 in 2026), ZIP3=021, gender female, tobacco use NO, income band <$25k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=021, select Middlesex, MA — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Hypertension, Type 2 Diabetes","Add these medications exactly: Metformin 500 mg tablet (twice daily) = $8/mo; Lisinopril 10 mg tablet (daily) = $5/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $13/mo and $156/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $13 and annual = $156 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1957 (age 69 in 2026), ZIP3=100, gender male, tobacco use YES, income band $25k–$50k, cost preference 'predictability'","From the county dropdown that auto-populates for ZIP3=100, select Hudson, NJ — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: COPD","Add these medications exactly: Tiotropium (Spiriva) 18 mcg inhaler (daily) = $380/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $380/mo and $4,560/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $380 and annual = $4,560 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1950 (age 76 in 2026), ZIP3=190, gender female, tobacco use NO, income band $50k–$75k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=190, select Bucks, PA — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Atrial Fibrillation, Hyperlipidemia","Add these medications exactly: Eliquis 5 mg tablet (twice daily) = $550/mo; Atorvastatin 40 mg tablet (daily) = $12/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $562/mo and $6,744/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $562 and annual = $6,744 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1941 (age 85 in 2026), ZIP3=303, gender male, tobacco use NO, income band $75k–$100k, cost preference 'predictability'","From the county dropdown that auto-populates for ZIP3=303, select Cobb, GA — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Rheumatoid Arthritis","Add these medications exactly: Humira 40 mg/0.4 mL injection (every 2 weeks) = $6,900/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $6,900/mo and $82,800/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $6,900 and annual = $82,800 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1953 (age 73 in 2026), ZIP3=331, gender nonbinary, tobacco use NO, income band $100k–$150k, cost preference 'predictability'","From the county dropdown that auto-populates for ZIP3=331, select Miami-Dade, FL — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Congestive Heart Failure, Hypertension","Add these medications exactly: Entresto 97/103 mg tablet (twice daily) = $620/mo; Furosemide 40 mg tablet (daily) = $6/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $626/mo and $7,512/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $626 and annual = $7,512 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1942 (age 84 in 2026), ZIP3=441, gender female, tobacco use YES, income band $25k–$50k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=441, select Cuyahoga, OH — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Asthma, GERD","Add these medications exactly: Albuterol 90 mcg inhaler (PRN) = $55/mo; Omeprazole 20 mg capsule (daily) = $10/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $65/mo and $780/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $65 and annual = $780 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1958 (age 68 in 2026), ZIP3=606, gender male, tobacco use NO, income band $50k–$75k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=606, select Cook, IL — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Chronic Kidney Disease Stage 3","Add these medications exactly: Losartan 50 mg tablet (daily) = $7/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $7/mo and $84/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $7 and annual = $84 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1957 (age 69 in 2026), ZIP3=750, gender female, tobacco use NO, income band <$25k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=750, select Collin, TX — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Depression, Anxiety","Add these medications exactly: Sertraline 100 mg tablet (daily) = $9/mo; Buspirone 10 mg tablet (twice daily) = $14/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $23/mo and $276/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $23 and annual = $276 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1959 (age 67 in 2026), ZIP3=802, gender male, tobacco use NO, income band $75k–$100k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=802, select Adams, CO — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Osteoporosis","Add these medications exactly: Alendronate 70 mg tablet (weekly) = $18/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $18/mo and $216/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $18 and annual = $216 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1949 (age 77 in 2026), ZIP3=891, gender female, tobacco use NO, income band $25k–$50k, cost preference 'predictability'","From the county dropdown that auto-populates for ZIP3=891, select Clark, NV — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Multiple Sclerosis","Add these medications exactly: Ocrevus 300 mg/10 mL infusion (every 6 months amortized) = $34,000/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $34,000/mo and $408,000/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $34,000 and annual = $408,000 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1940 (age 86 in 2026), ZIP3=787, gender male, tobacco use YES, income band <$25k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=787, select Hays, TX — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Parkinson's Disease","Add these medications exactly: Carbidopa-Levodopa 25-100 mg tablet (TID) = $22/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $22/mo and $264/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $22 and annual = $264 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1942 (age 84 in 2026), ZIP3=981, gender female, tobacco use NO, income band $50k–$75k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=981, select King, WA — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Hypothyroidism, Hyperlipidemia","Add these medications exactly: Levothyroxine 75 mcg tablet (daily) = $6/mo; Rosuvastatin 20 mg tablet (daily) = $14/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $20/mo and $240/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $20 and annual = $240 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1957 (age 69 in 2026), ZIP3=550, gender male, tobacco use NO, income band $75k–$100k, cost preference 'predictability'","From the county dropdown that auto-populates for ZIP3=550, select Anoka, MN — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Type 1 Diabetes","Add these medications exactly: Insulin Lispro (Humalog) 100 U/mL vial (as directed) = $330/mo; Insulin Glargine (Lantus) 100 U/mL vial (daily) = $290/mo; Dexcom G7 CGM (DME) (continuous) = $420/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $1,040/mo and $12,480/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $1,040 and annual = $12,480 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1948 (age 78 in 2026), ZIP3=602, gender male, tobacco use NO, income band $25k–$50k, cost preference 'minimize monthly'","From the county dropdown that auto-populates for ZIP3=602, select Cook, IL — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Coronary Artery Disease, Hyperlipidemia","Add these medications exactly: Clopidogrel 75 mg tablet (daily) = $9/mo; Simvastatin 20 mg tablet (daily) = $5/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $14/mo and $168/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $14 and annual = $168 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
    ...
    preconditions: "Logged in as QA. /scenario/new is reachable and Lovable Cloud is healthy.",
    steps: ["Start from home page where the user clicks Create My Scenario","Enter birth year 1952 (age 74 in 2026), ZIP3=148, gender male, tobacco use NO, income band $25k–$50k, cost preference 'predictability'","From the county dropdown that auto-populates for ZIP3=148, select Allegany, NY — this scopes the carrier/plan check to only plans available in that county","Add these conditions exactly: Alzheimer's Disease (early)","Add these medications exactly: Donepezil 10 mg tablet (daily) = $15/mo","Submit the wizard and capture the generated Scenario ID (SCN-YYYY-XXXX-XXXX) — write it in QA notes","On the confirmation page, click \"Copy scenario link\" — verify the link uses the form /scenario/<SCN code>. Paste it into a new browser tab and confirm the scenario detail page loads with the SCN ID, summary card, share button, and expert opt-in trigger all present","On the confirmation page, verify the header echoes back every demographic, condition, and medication you entered character-for-character","Click 'Download PDF' and 'Download Excel' to generate the system output reports","Open each report and locate the Medication Cost summary. The total MUST equal $15/mo and $180/yr exactly","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match what you entered in steps 2–4"],
    expected: "Scenario is created successfully and a new SCN- code is issued. Both PDF and XLSX show monthly medication retail = $15 and annual = $180 exactly. Every demographic, condition, and medication line in the system output matches the values QA entered in the wizard.",
    path: "/scenario/new",
  },
  {
  ...
  },
  {
    ...
    expected: "Each invalid lookup shows a user-friendly inline error ('Scenario not found or expired' / 'Invalid scenario code format'). Page does not crash, no console errors, no PII leaked.",
    path: "/advisor",
  },
  {
    ...
    expected: "By the 11th attempt the lookup is blocked with 'Rate limit exceeded — wait a minute before trying again'. The block lifts ~60 seconds later.",
    path: "/advisor",
  },
  {
  ...
  },
  {
    ...
    expected: "QA sees scenarios read-only — no assign dropdown, no assign button. /admin redirects QA away or shows 'not authorized'. Direct RPC call returns 'Admin role required'. No assignment is recorded.",
    path: "/testing",
  },
