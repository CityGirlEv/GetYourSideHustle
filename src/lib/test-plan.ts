...
export const TEST_CASES: TestCase[] = [
  ...
  // ===== QA Scenarios — audit-check seeded scenarios against the output report =====
  {
    id: "SCEN-QA-01", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-01-DAKE — Hypertension (+co) · $13/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-01-DAKE was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-01-DAKE into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1945 (age 81 in 2026), ZIP3 021, female, non-tobacco, income band <$25k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Hypertension, Type 2 Diabetes","Verify the Medications section lists exactly: Metformin 500 mg tablet (twice daily) = $8/mo; Lisinopril 10 mg tablet (daily) = $5/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $13/mo and $156/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $13 and annual = $156 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-01-DAKE",
  },
  {
    id: "SCEN-QA-02", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-02-LLGO — COPD · $380/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-02-LLGO was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-02-LLGO into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1957 (age 69 in 2026), ZIP3 100, male, tobacco user, income band $25k–$50k, cost preference 'predictability'","Verify the Conditions section shows exactly: COPD","Verify the Medications section lists exactly: Tiotropium (Spiriva) 18 mcg inhaler (daily) = $380/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $380/mo and $4,560/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $380 and annual = $4,560 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-02-LLGO",
  },
  {
    id: "SCEN-QA-03", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-03-6U34 — Atrial Fibrillation (+co) · $562/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-03-6U34 was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-03-6U34 into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1950 (age 76 in 2026), ZIP3 190, female, non-tobacco, income band $50k–$75k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Atrial Fibrillation, Hyperlipidemia","Verify the Medications section lists exactly: Eliquis 5 mg tablet (twice daily) = $550/mo; Atorvastatin 40 mg tablet (daily) = $12/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $562/mo and $6,744/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $562 and annual = $6,744 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-03-6U34",
  },
  {
    id: "SCEN-QA-04", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-04-CSO3 — Rheumatoid Arthritis · $6,900/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-04-CSO3 was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-04-CSO3 into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1941 (age 85 in 2026), ZIP3 303, male, non-tobacco, income band $75k–$100k, cost preference 'predictability'","Verify the Conditions section shows exactly: Rheumatoid Arthritis","Verify the Medications section lists exactly: Humira 40 mg/0.4 mL injection (every 2 weeks) = $6,900/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $6,900/mo and $82,800/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $6,900 and annual = $82,800 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-04-CSO3",
  },
  {
    id: "SCEN-QA-05", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-05-KIM4 — Congestive Heart Failure (+co) · $626/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-05-KIM4 was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-05-KIM4 into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1953 (age 73 in 2026), ZIP3 331, nonbinary, non-tobacco, income band $100k–$150k, cost preference 'predictability'","Verify the Conditions section shows exactly: Congestive Heart Failure, Hypertension","Verify the Medications section lists exactly: Entresto 97/103 mg tablet (twice daily) = $620/mo; Furosemide 40 mg tablet (daily) = $6/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $626/mo and $7,512/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $626 and annual = $7,512 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-05-KIM4",
  },
  {
    id: "SCEN-QA-06", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-06-KCDB — Asthma (+co) · $65/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-06-KCDB was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-06-KCDB into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1942 (age 84 in 2026), ZIP3 441, female, tobacco user, income band $25k–$50k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Asthma, GERD","Verify the Medications section lists exactly: Albuterol 90 mcg inhaler (PRN) = $55/mo; Omeprazole 20 mg capsule (daily) = $10/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $65/mo and $780/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $65 and annual = $780 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-06-KCDB",
  },
  {
    id: "SCEN-QA-07", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-07-HI1W — Chronic Kidney Disease Stage 3 · $7/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-07-HI1W was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-07-HI1W into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1958 (age 68 in 2026), ZIP3 606, male, non-tobacco, income band $50k–$75k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Chronic Kidney Disease Stage 3","Verify the Medications section lists exactly: Losartan 50 mg tablet (daily) = $7/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $7/mo and $84/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $7 and annual = $84 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-07-HI1W",
  },
  {
    id: "SCEN-QA-08", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-08-97A7 — Depression (+co) · $23/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-08-97A7 was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-08-97A7 into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1957 (age 69 in 2026), ZIP3 750, female, non-tobacco, income band <$25k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Depression, Anxiety","Verify the Medications section lists exactly: Sertraline 100 mg tablet (daily) = $9/mo; Buspirone 10 mg tablet (twice daily) = $14/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $23/mo and $276/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $23 and annual = $276 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-08-97A7",
  },
  {
    id: "SCEN-QA-09", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-09-1QCL — Osteoporosis · $18/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-09-1QCL was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-09-1QCL into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1959 (age 67 in 2026), ZIP3 802, male, non-tobacco, income band $75k–$100k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Osteoporosis","Verify the Medications section lists exactly: Alendronate 70 mg tablet (weekly) = $18/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $18/mo and $216/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $18 and annual = $216 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-09-1QCL",
  },
  {
    id: "SCEN-QA-10", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-10-SOR7 — Multiple Sclerosis · $34,000/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-10-SOR7 was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-10-SOR7 into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1949 (age 77 in 2026), ZIP3 891, female, non-tobacco, income band $25k–$50k, cost preference 'predictability'","Verify the Conditions section shows exactly: Multiple Sclerosis","Verify the Medications section lists exactly: Ocrevus 300 mg/10 mL infusion (every 6 months, amortized) = $34,000/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $34,000/mo and $408,000/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $34,000 and annual = $408,000 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-10-SOR7",
  },
  {
    id: "SCEN-QA-11", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-11-KR3D — Parkinson's Disease · $22/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-11-KR3D was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-11-KR3D into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1940 (age 86 in 2026), ZIP3 787, male, tobacco user, income band <$25k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Parkinson's Disease","Verify the Medications section lists exactly: Carbidopa-Levodopa 25-100 mg tablet (TID) = $22/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $22/mo and $264/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $22 and annual = $264 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-11-KR3D",
  },
  {
    id: "SCEN-QA-12", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-12-A1ZJ — Hypothyroidism (+co) · $20/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-12-A1ZJ was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-12-A1ZJ into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1942 (age 84 in 2026), ZIP3 981, female, non-tobacco, income band $50k–$75k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Hypothyroidism, Hyperlipidemia","Verify the Medications section lists exactly: Levothyroxine 75 mcg tablet (daily) = $6/mo; Rosuvastatin 20 mg tablet (daily) = $14/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $20/mo and $240/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $20 and annual = $240 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-12-A1ZJ",
  },
  {
    id: "SCEN-QA-13", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-13-2T7C — Type 1 Diabetes · $1,040/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-13-2T7C was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-13-2T7C into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1957 (age 69 in 2026), ZIP3 550, male, non-tobacco, income band $75k–$100k, cost preference 'predictability'","Verify the Conditions section shows exactly: Type 1 Diabetes","Verify the Medications section lists exactly: Insulin Lispro (Humalog) 100 U/mL vial = $330/mo; Insulin Glargine (Lantus) 100 U/mL vial = $290/mo; Dexcom G7 CGM (DME) = $420/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $1,040/mo and $12,480/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $1,040 and annual = $12,480 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-13-2T7C",
  },
  {
    id: "SCEN-QA-14", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-14-0Q2O — Coronary Artery Disease (+co) · $14/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-14-0Q2O was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-14-0Q2O into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1959 (age 67 in 2026), ZIP3 331, female, tobacco user, income band $25k–$50k, cost preference 'predictability'","Verify the Conditions section shows exactly: Coronary Artery Disease, Hypertension","Verify the Medications section lists exactly: Clopidogrel 75 mg tablet (daily) = $8/mo; Metoprolol 50 mg tablet (twice daily) = $6/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $14/mo and $168/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $14 and annual = $168 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-14-0Q2O",
  },
  {
    id: "SCEN-QA-15", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-15-7OIT — (none reported) · $0/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-15-7OIT was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-15-7OIT into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1949 (age 77 in 2026), ZIP3 972, male, non-tobacco, income band $50k–$75k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: (none reported)","Verify the Medications section shows zero medications (no rows)","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary — confirm it reports $0/mo and $0/yr (or 'no medications')","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX render with $0 medication totals, the listed demographics, and no condition rows. No NaN, blank, or 'undefined' values appear anywhere in the report.",
    path: "/advisor/scenario/SCN-QA-15-7OIT",
  },
  {
    id: "SCEN-QA-16", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-16-5SAE — Migraine (+co) · $31/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-16-5SAE was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-16-5SAE into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1948 (age 78 in 2026), ZIP3 480, female, non-tobacco, income band $100k–$150k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Migraine, Hypertension","Verify the Medications section lists exactly: Sumatriptan 50 mg tablet (PRN) = $25/mo; Amlodipine 10 mg tablet (daily) = $6/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $31/mo and $372/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $31 and annual = $372 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-16-5SAE",
  },
  {
    id: "SCEN-QA-17", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-17-NZ1L — Glaucoma (+co) · $645/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-17-NZ1L was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-17-NZ1L into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1958 (age 68 in 2026), ZIP3 017, female, non-tobacco, income band $25k–$50k, cost preference 'minimize monthly'","Verify the Conditions section shows exactly: Glaucoma, Type 2 Diabetes","Verify the Medications section lists exactly: Latanoprost 0.005% eye drops (daily) = $35/mo; Jardiance 25 mg tablet (daily) = $610/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $645/mo and $7,740/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $645 and annual = $7,740 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-17-NZ1L",
  },
  {
    id: "SCEN-QA-18", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-18-655I — Crohn's Disease · $25,000/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-18-655I was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-18-655I into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1947 (age 79 in 2026), ZIP3 275, male, non-tobacco, income band $75k–$100k, cost preference 'predictability'","Verify the Conditions section shows exactly: Crohn's Disease","Verify the Medications section lists exactly: Stelara 90 mg/mL injection (every 8 weeks, amortized) = $25,000/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $25,000/mo and $300,000/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $25,000 and annual = $300,000 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-18-655I",
  },
  {
    id: "SCEN-QA-19", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-19-6FD5 — Breast Cancer (in remission) · $18/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-19-6FD5 was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-19-6FD5 into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1948 (age 78 in 2026), ZIP3 920, female, non-tobacco, income band $50k–$75k, cost preference 'predictability'","Verify the Conditions section shows exactly: Breast Cancer (in remission)","Verify the Medications section lists exactly: Anastrozole 1 mg tablet (daily) = $18/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $18/mo and $216/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $18 and annual = $216 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-19-6FD5",
  },
  {
    id: "SCEN-QA-20", area: "Scenarios", priority: "P2",
    title: "Audit SCN-QA-20-RGOC — Alzheimer's Disease (early) · $15/mo expected",
    preconditions: "Logged in as QA or admin. Scenario SCN-QA-20-RGOC was pre-seeded into the scenarios table.",
    steps: ["Log in as a QA user and open /advisor","Enter scenario code SCN-QA-20-RGOC into the lookup field and submit","On the scenario detail page, verify the header shows: birth year 1952 (age 74 in 2026), ZIP3 148, male, non-tobacco, income band $25k–$50k, cost preference 'predictability'","Verify the Conditions section shows exactly: Alzheimer's Disease (early)","Verify the Medications section lists exactly: Donepezil 10 mg tablet (daily) = $15/mo","Click 'Download PDF · 1 cr' (and separately 'Excel · 1 cr') to generate the output reports","Open each report and locate the Medication Cost summary. Manually sum the per-med monthly retail figures from step 5 — the total MUST equal $15/mo and $180/yr","Cross-check that the conditions, demographics, and ZIP3 printed in the PDF and XLSX match the values from steps 3–4 character-for-character"],
    expected: "Both PDF and XLSX show monthly medication retail = $15 and annual = $180 exactly. Every demographic field, condition, and medication line matches the values audited in steps 3–5.",
    path: "/advisor/scenario/SCN-QA-20-RGOC",
  },
