...
const ScenarioClaimedEmail = ({ recipientName, advisorName, scenarioCode, scenarioUrl }: Props) => (
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          and will be in touch shortly to walk you through your Medicare options.
        </Text>
        {scenarioUrl ? (
