    ...
    <Html lang="en" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            End-of-day report for <strong>{reportDateLabel}</strong>. Below are the tests QA
            marked complete in the Testing Portal on {SITE_NAME}.
          </Text>
...
const noteSnippet = { color: '#64748b', fontSize: '13px', fontStyle: 'italic' as const }
