...
const PLAN_DEFINITIONS: StripePlanDefinition[] = [
  {
    ...
    description: `${LEAD_SUBSCRIPTION_PRICING.introductory.discountPercent}% off for new partners — up to ${LEAD_SUBSCRIPTION_PRICING.includedLeadsPerMonth} leads/month`,
    monthlyFee: LEAD_SUBSCRIPTION_PRICING.introductory.monthlyFee,
    leadCount: LEAD_SUBSCRIPTION_PRICING.includedLeadsPerMonth,
  ...
  },
  {
    ...
    description: `Up to ${LEAD_SUBSCRIPTION_PRICING.includedLeadsPerMonth} exclusive leads per month`,
