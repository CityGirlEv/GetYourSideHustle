...
const AUTOMATED_VITEST_CASES_RAW: GyshTestCase[] = [
  {
    id: "VT-AUTH-001",
    area: "Vitest",
    title: "login API authenticates Tina & Evelyn against D1 (not localStorage)",
    priority: "P0",
    roles: ["qa", "admin"],
    assignees: ["vitest"],
    suite: "vitest",
  ...
  },
  {
    ...
    expected: "Manual cases use Tina, Evelyn / Lyriq; Vitest/Playwright cases use suite owners",
  },
  {
    id: "VT-WIZARD-001",
    area: "Vitest",
  ...
  },
  {
    id: "VT-SCHED-001",
    area: "Vitest",
    title: "Schedule Suite checkbox sets Done / Not Started status",
    priority: "P0",
    roles: ["qa", "all"],
    assignees: ["vitest"],
    suite: "vitest",
    path: "dashboard",
    steps: [
      "Run: bun run test -- src/lib/__tests__/hustle-schedule.test.ts",
      "Confirm scheduleStatusFromCheckboxChecked + applyScheduleBlockCheckbox assertions pass",
    ],
    expected: "Checked → Done; unchecked → Not Started; progress/overdue use Done correctly",
  },
  {
    id: "VT-LH-001",
    area: "Lighthouse",
  ...
  },
  {
    id: "VT-BETA-NDA-001",
    area: "Vitest",
    title: "Beta Tester NDA version, acceptance, and dashboard stats",
    priority: "P0",
    roles: ["qa", "all"],
    assignees: ["vitest"],
    suite: "vitest",
...
const AUTOMATED_PLAYWRIGHT_CASES_RAW: GyshTestCase[] = [
  ...
  },
  {
    id: "PW-SMOKE-005",
    area: "Playwright",
    title: "Footer links navigate About, Join, Contact, and Privacy Policy",
    priority: "P1",
    roles: ["qa"],
    assignees: ["playwright"],
    suite: "playwright",
    path: "dashboard",
    steps: ["Scroll to footer", "Click About, Join, Contact Us, Privacy Policy"],
  ...
  },
  {
    id: "PW-SMOKE-008",
    area: "Playwright",
    title: "Privacy Policy page is reachable from the footer and /privacy",
    priority: "P0",
    roles: ["qa", "admin"],
    assignees: ["playwright"],
    suite: "playwright",
    ...
    steps: [
      ...
      "Confirm title, effective date, and Children’s Privacy / COPPA copy",
      "Open /privacy directly",
    ],
    expected: "Privacy Policy page loads with the published policy and stays linked from every page footer",
  },
  {
    id: "PW-BETA-NDA-001",
    area: "Playwright",
    title: "Beta Tester NDA page and signup acceptance unlock the testing dashboard",
    priority: "P0",
    roles: ["qa", "all"],
    assignees: ["playwright"],
    suite: "playwright",
    ...
    expected: "NDA is readable from the footer; signup requires electronic acceptance before testing unlocks",
  },
  {
    id: "PW-JOIN-001",
    area: "Playwright",
  ...
  },
  {
    id: "PW-SCHED-001",
    area: "Playwright",
    title: "Schedule Suite checkbox sets Done / Not Started",
    priority: "P0",
    roles: ["qa", "all"],
    assignees: ["playwright"],
    suite: "playwright",
    path: "dashboard",
    steps: [
      "Run: npx playwright test e2e/schedule-suite-status.spec.ts",
      "Confirm checked → Done and unchecked → Not Started via scheduleStatusFromCheckboxChecked",
      "Confirm Join page still shows Schedule Suite callout",
    ],
    expected: "Checkbox harness + Join schedule suite callout pass",
  },
