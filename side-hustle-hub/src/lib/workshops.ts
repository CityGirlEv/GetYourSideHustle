...
export const DEFAULT_SPEAKERS: GuestSpeaker[] = [
  {
    ...
    bio: "IT educator and storyteller behind Kevina Starr Stories. Tina leads family-friendly workshops on confidence, kindness, and junior earning skills.",
    topics: ["Kids Glow", "Storytelling", "Junior Hustles", "Parent Coaching"],
    accent: "#9B2F28",
    initials: "TB",
  },
  {
  ...
  },
  {
    ...
    bio: "Guest speaker for Kids and Youth sessions — confidence, safe first hustles, and encouragement for young Glow Getters and junior earners (with parents nearby).",
    topics: ["Kids & Youth", "Confidence", "Safe First Hustles", "Junior Motivation"],
    accent: "#2E7D5A",
    initials: "LG",
  },
];
...
export const DEFAULT_WORKSHOPS: Workshop[] = [
  {
    ...
    blurb: "Story time + parent playbook: turn Kevina Starr episodes into weekly confidence and junior hustle routines.",
    date: "TBD",
    time: "6:30 PM EST",
    format: "Live Zoom",
    audience: "family",
  ...
  },
  {
    ...
    title: "Junior Earnings Fair (Kids Session)",
    ...
    tags: ["Junior Hustles", "Safety", "Youth"],
  },
  {
    id: "pod-etsy-sprint",
